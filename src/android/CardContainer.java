...
public class CardContainer extends AdapterView<ListAdapter> {
    ...
    // this code will be fired on swipe right
    ...
    private void initFromXml(AttributeSet attr) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attr,
                new int [] {resources.getIdentifier("CardContainer","styleable",package_name)});

        setGravity(a.getInteger(resources.getIdentifier("CardContainer_android_gravity","styleable",package_name), Gravity.CENTER));
        int orientation = a.getInteger(resources.getIdentifier("CardContainer_orientation","styleable",package_name), 1);
